...
for train_i in range(TRAINING_NUM):
    train_file_path = "../data/problem2/train_" + str(train_i) + ".csv"
    train_file = np.loadtxt(train_file_path, delimiter=',', dtype=np.float32, skiprows=0)

for test_i in range(TEST_NUM):
    test_file_path = "../data/problem2/test_" + str(train_i) + ".csv"
